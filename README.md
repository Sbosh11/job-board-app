...
A modern job board application built with React, TypeScript, Vite, and a mock REST API using `json-server` and Tailwind for styling. The app focuses on fast job discovery, intelligent search, and smooth application handling.

Live demo: https://job-board-app-sand.vercel.app/
